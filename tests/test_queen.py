...
class TestQueen(unittest.TestCase):
    ...
    def test_check_move_invalid_not_straight_or_diagonal(self):
        ...
        # Algunos de estos movimientos pueden ser válidos si son diagonales o lineales, por lo que ajustamos
        # Para asegurarnos, seleccionamos movimientos que no están en línea recta ni en diagonal
        truly_invalid_moves = [
            (4, 5), (5, 6), (2, 5), (1, 6),
            (5, 2), (2, 4), (4, 1), (1, 5)
        ]
